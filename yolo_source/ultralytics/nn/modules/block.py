...
# =============================================================================
#      YOLOv8-UAV Ultimate Modules (Final Approved Version)
#      1. SPDConv: 无损下采样 (保留微小特征)
#      2. MultiSEAM: 复杂背景分离 (Context核心)
#      3. EMA: 强力通道注意力 (GroupNorm版)
# =============================================================================
# =============================================================================
#      YOLOv8-UAV Ultimate Modules (User Defined + Optimized)
#      1. SPDConv: 用户提供的原生实现 (无损下采样)
#      2. MultiSEAM: 复杂背景分离 (Context核心)
#      3. EMA: 强力通道注意力 (GroupNorm优化版)
# =============================================================================
